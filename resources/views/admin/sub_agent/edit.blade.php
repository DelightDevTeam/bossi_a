        ...
        <div class="col-12 col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="d-lg-flex">
                        <div>
                            <h5 class="mb-0">Edit Sub Agent</h5>

                        </div>
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <a class="btn btn-icon btn-2 btn-primary" href="{{ route('admin.subagent.index') }}">
                ...
                <div class="card-body">
                    <form role="form" method="POST" class="text-start" action="{{ route('admin.subagent.getChangePassword', $agent->id) }}">
                        @csrf
                        @method('PUT')
                                ...
                                <div>
                                    <label class="d-flex gap-2 align-items-center">
                                        <input
                                            type="checkbox"
                                            name="permissions[]"
                                            value="{{ $permission->name }}" {{in_array($permission->name, $agentPermissions) ? 'checked' : ''}}>
